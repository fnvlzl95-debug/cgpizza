...
export function KitchenVideo({ src, poster, label }: KitchenVideoProps) {
  ...
  return (
    <div className="absolute inset-0">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 bg-gradient-to-b from-navy-900/90 via-navy-900/40 via-45% to-navy-900/10"
      />
      ...
      {started ? null : (
        ...
        >
          <span className="relative flex h-16 w-16 items-center justify-center rounded-full border-2 border-white bg-navy-900/45 text-white transition-transform duration-300 group-hover:scale-105 group-focus-visible:scale-105 group-focus-visible:ring-4 group-focus-visible:ring-yellow-500/70 lg:h-[4.6rem] lg:w-[4.6rem]">
