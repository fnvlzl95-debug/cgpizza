...
export function PortedFloatingKakaoButton() {
  ...
  return (
    <a
      ...
      className={`fixed right-3 z-40 inline-flex items-center justify-center rounded-[8px] border border-[#e1ca00] bg-[#FEE500] px-4 py-3 text-[0.94rem] font-black leading-none text-black shadow-[0_16px_34px_rgba(0,0,0,0.22)] transition-all duration-300 hover:-translate-y-1 md:bottom-6 md:right-6 md:min-h-[4.2rem] md:px-6 md:text-[1.18rem] ${
