...
export function KakaoBadge({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      />
      <span className="-mt-1 rounded-full bg-yellow-500 px-3 py-1 text-center text-[0.68rem] font-black leading-[1.25] tracking-[-0.03em] text-navy-900 shadow-raise lg:-mt-[0.3vw] lg:px-[0.8vw] lg:text-[clamp(0.65rem,0.8vw,0.84rem)]">
        최강피자
