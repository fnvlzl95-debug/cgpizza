    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-[93.25rem] px-5 md:px-8 lg:px-0">
        <div className="motion-reveal text-center">
          ...
          <p className="mx-auto mt-3 max-w-[22rem] text-balance text-[0.95rem] text-navy-900/75 sm:max-w-none lg:mt-[0.8vw] lg:text-[clamp(0.9rem,1.25vw,1.32rem)]">
            {data.subhead}
          </p>
        </div>
          ...
          {data.cards.map((card) => (
            <li key={card.title} className="flex flex-col items-center lg:flex-1 lg:flex-row lg:items-stretch">
              <article className="flex w-full flex-1 flex-col items-center rounded-3xl bg-cream-card px-5 py-7 text-center shadow-[0_16px_38px_rgba(1,23,80,0.14)] lg:px-[1.2vw] lg:py-[2.5vw]">
                ...
                <span className="mt-5 flex aspect-square w-[10.5rem] items-center justify-center overflow-hidden rounded-full bg-[#F3EAD4] lg:mt-[2vw] lg:w-[13.4vw]">
                  <CardArt art={card.art} />
                </span>

                <p className="mt-auto pt-5 text-[0.9rem] leading-[1.8] text-navy-900/80 lg:pt-[2vw] lg:text-[clamp(0.9rem,1.14vw,1.2rem)]">
              ...
              {card.connector ? (
                <span className="my-3 flex justify-center lg:my-0 lg:-mx-[1.8vw] lg:mt-[12.4vw] lg:self-start">
